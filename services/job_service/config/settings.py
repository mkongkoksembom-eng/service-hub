...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "sh_jobs"),
...
CELERY_BEAT_SCHEDULE = {
    "expire-overdue-jobs": {
        "task": "apps.jobs.tasks.expire_overdue_jobs",
...
# Maximum number of providers notified per job post. Set to 0 for no limit.
JOB_NOTIFICATION_PROVIDER_LIMIT = int(os.environ.get("JOB_NOTIFICATION_PROVIDER_LIMIT", 0))
