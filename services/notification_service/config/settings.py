...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,notification_service").split(",")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "sh_notifications"),
